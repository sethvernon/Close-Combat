...
inline bool Position::can_castle_kingside(Color side) const {
    return  NO_CASTLES; // MSM  castleRights & (1+int(side));
}

inline bool Position::can_castle_queenside(Color side) const {
    return NO_CASTLES; // MSM  castleRights & (4+4*int(side));
}

inline bool Position::can_castle(Color side) const {
    return NO_CASTLES; // MSM can_castle_kingside(side) || can_castle_queenside(side);
}
